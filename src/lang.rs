...
impl Lang {
    pub fn english() -> Self {
        Lang {
            ...
            recommender_go_back: "9. Go Back (ESC)",
    ...
    pub fn spanish() -> Self {
        Lang {
            ...
            recommender_go_back: "9. Volver (ESC)",
            series: super::wordlist::SERIES,
            mangas: super::wordlist::MANGA,
            books: super::wordlist::BOOKS,
            animes: super::wordlist::ANIME,
    ...
    pub fn portuguese() -> Self {
        Lang {
            ...
            recommender_go_back: "9. Voltar (ESC)",
            series: super::wordlist::SERIES,
            mangas: super::wordlist::MANGA,
            books: super::wordlist::BOOKS,
            animes: super::wordlist::ANIME,
    ...
    pub fn german() -> Self {
        Lang {
            ...
            recommender_go_back: "9. Zurück (ESC)",
            series: super::wordlist::SERIES,
            mangas: super::wordlist::MANGA,
            books: super::wordlist::BOOKS,
            animes: super::wordlist::ANIME,
    ...
    pub fn dutch() -> Self {
        Lang {
            ...
            recommender_go_back: "9. Ga terug (ESC)",
            series: super::wordlist::SERIES,
            mangas: super::wordlist::MANGA,
            books: super::wordlist::BOOKS,
            animes: super::wordlist::ANIME,
